...
import com.alex.spring.boot.blog.service.ReplyService;
...
public class ReplyController {
    ...
    public Result reply(@PathVariable Integer commentId, String replyBody, Integer rootId) {
        ...
        try {
            replyService.saveReply(commentId, replyBody, rootId);
